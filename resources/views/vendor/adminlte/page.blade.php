    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="logo">
                ...
                <span class="logo-mini">{!! config('adminlte.logo_mini', '<b>M</b>P') !!}</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">{!! config('adminlte.logo', '<b>My</b>Pocket') !!}</span>
            </a>
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li>
                                        ...
                                        <ul class="menu">
                                          <li>
                                            <a href="#">
                                              <i class="fa fa-exclamation-triangle text-red"></i> Você tem 1 conta a pagar vencida.
                                            </a>
                                          </li>
                                          <li>
                                            <a href="#">
                                              <i class="fa fa-exclamation-triangle text-yellow"></i> Você tem 2 contas a pagar que vencerão essa semana.
                                            </a>
                                          </li>
                                        </ul>
                                      </li>
